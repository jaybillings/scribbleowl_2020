...
export default class GalleryNav extends Component {
  ...
  renderNavItems() {
    ...
    if (projIndex > 0) navItems.push(<li key={'prevproj'}>
      <Link to={`/gallery/${this.props.projList[projIndex - 1]}/`} className={'left'}>&lt;&lt; Prev Project</Link>
    </li>);
    ...
    if (projIndex < this.props.projList.length - 1) navItems.push(<li key={'nextproj'}>
      <Link to={`/gallery/${this.props.projList[projIndex + 1]}`} className={'right'}>Next Project &gt;&gt;</Link>
    </li>);
