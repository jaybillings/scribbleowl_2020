...
export default class GalleryNav extends Component {
  ...
  renderNavItems() {
    ...
    if (projIndex > 0) navItems.push(<li key={'prevproj'} className={'left'}><Link
    ...
    if (this.props.imgIndex > 0) navItems.push(<li key={'previmg'} className={'left'}><Link
    ...
    if (this.props.imgIndex < this.props.images.length) navItems.push(<li key={'nextimg'} className={'right'}><Link
    ...
    if (projIndex < this.props.projList.length) navItems.push(<li key={'nextproj'} className={'right'}><Link
